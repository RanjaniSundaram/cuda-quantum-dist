...
namespace cudaq::opt {
#define GEN_PASS_DEF_QAPDISTREMAPPINGPASS
...
private:
  ...
  LogicalResult mapFrontLayer(OpBuilder builder);
...
struct Mapper : public cudaq::opt::impl::QapDistReMappingPassBase<Mapper> {
  using QapDistReMappingPassBase::QapDistReMappingPassBase;
  ...
  void runOnOperation() override {
    ...
    std::vector<int> Identity(d.getNumQubits());
    ...
    SabreRouter *temprouter = new SabreRouter(
        d, wireToVirtualQ, placement, Identity, tempRemapper, extendedLayerSize,
    ...
    // Route
    SabreRouter router(d, wireToVirtualQ, placement,solution, Remapper,
